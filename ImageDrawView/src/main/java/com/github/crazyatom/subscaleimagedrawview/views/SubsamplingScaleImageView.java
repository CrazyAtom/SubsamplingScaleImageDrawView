...
import com.github.crazyatom.subscaleimagedrawview.R.styleable;
import com.github.crazyatom.subscaleimagedrawview.decoder.CompatDecoderFactory;
import com.github.crazyatom.subscaleimagedrawview.decoder.DecoderFactory;
import com.github.crazyatom.subscaleimagedrawview.decoder.ImageDecoder;
import com.github.crazyatom.subscaleimagedrawview.decoder.ImageRegionDecoder;
import com.github.crazyatom.subscaleimagedrawview.decoder.SkiaImageDecoder;
import com.github.crazyatom.subscaleimagedrawview.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends ViewGroup {
     ...
     */
    public Rect sourceToViewRect(Rect sRect, Rect vTarget) {
        vTarget.set(
    ...
    /**
     * Convert source rect to screen rect, float values.
     */
    public RectF sourceToViewRect(RectF sRect, RectF vTarget) {
        vTarget.set(
                (int)sourceToViewX(sRect.left),
                (int)sourceToViewY(sRect.top),
                (int)sourceToViewX(sRect.right),
